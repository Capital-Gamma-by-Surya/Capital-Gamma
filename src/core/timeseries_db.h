...
public:
	...
	void post(uint64_t data) {
		...
		if (i < capacity_) {
			...
			std::cerr << "database capacity exceeded..." << std::endl;
		}
	}
	...
	void print_statistics() {
		...
		std::cout << "min. latency: " << min << "ns, max. latency: " << max << "ns" << std::endl;
		std::cout << "avg. latency: " << total_lat / db_size << "ns" << std::endl;
		std::cout << "total latency: " << total_lat/1000 << "us" << std::endl;
	}
