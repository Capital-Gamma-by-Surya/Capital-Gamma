#include <capgam/common/scoped_timer.h>
#include <capgam/core/data_transformer.h>
#include <capgam/core/message_structs.h>
#include <capgam/core/order_router.h>
#include <capgam/core/ring_buffer.h>
#include <capgam/core/timeseries_db.h>
...
void ring_buffer() {
    ...
    std::thread consumer_thread{consumer, std::ref(ring), std::ref(transformer),
                                std::ref(router)};
