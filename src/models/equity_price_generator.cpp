...
EquityPriceGenerator::EquityPriceGenerator(double spot_price, int num_time_steps, 
  double time_to_exp, double volatility, double rf_rate, double div_rate) : 
  spot_{spot_price}, num_time_steps_{num_time_steps}, time_to_exp_{time_to_exp},
  volatility_{volatility}, rf_rate_{rf_rate}, div_rate_{div_rate}, dt_{time_to_exp/num_time_steps} {}
